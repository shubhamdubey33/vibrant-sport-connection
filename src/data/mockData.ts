...
const tugOfWarNamesDarkKnights = ['Anish Verma', 'Prakash Barkhane', 'SUBODH SUNDRIYAL', 'Shalini', 'Maya Chaurasia', 'Mayank Pandey', 'Anagha Jagdale', 'Manisha chahal', 'Pritesh ranjan', 'Keshav Suman', 'Arnab Hati', 'Zahir Hussain', 'Shivani Karnwal', 'Shitala Prasad Maurya', 'Sachin Negi', 'Rakshit Pandey', 'Bhuwan Chandra Pant', 'Azam Ahmad', 'Piyush Chauhan', 'Jatin Kaushal'];

const tugOfWarNamesEagleWarriors = ['Jacky', 'Deepu', 'Swati', 'Rohit Kandpal', 'Sangeeta Rawat', 'Vikas Ahiwal', 'Krishna Rajput', 'Raj Singh', 'Junaid', 'Sumyra Masood', 'Hasan', 'Archita', 'Khushboo Sharma', 'Sachin Sharma', 'Amit', 'Gulafsha Parween', 'Neeraj', 'Sukh Kumar', 'Lalit Chauhan', 'Prashant'];

const tugOfWarNamesRoyalStrikers = ['Neenanjali', 'Wairokpam Ogaka', 'Jagdeep', 'Sameer Sharma', 'Sagar Kumar', 'Ankit Goyat', 'Gajendra Singh', 'Nisha', 'Arjun Kumar', 'Dilnawaz Ahmad', 'Abhishek Gaur', 'Kuldeep Kumar Varun', 'Satyapal Singh', 'Rajdeepak Gupta', 'Suraj Prajapati', 'Atul Rawat', 'Abdul Karim Ansari', 'Tushar Kant', 'Aman Srivastava', 'Tanuj Sharma'];

const tugOfWarNamesSupremeSpartans = ['Puneet Sharma', 'Ruapnshak', 'Neeraj Pandey', 'Charu Rajput', 'Ramesh Kumawatt', 'Anoop Singh', 'Priya Singh', 'Amit Kumar', 'Vivek Kumar Anuj', 'Suryanshu Mankotia', 'Mohd Muhib', 'Pankaj Kumar', 'Farhan Ahmad', 'Deepanshu Rawat', 'Prashant Kashyap', 'Chirag Ahuja', 'Ayush Mishra', 'Jai Prakash', 'Hem Singh', 'Pankaj Kasaudhan'];
